...
export interface ApiBlogBlog extends Schema.CollectionType {
  ...
  attributes: {
    ...
    covering: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
...
export interface ApiMagazineMagazine extends Schema.CollectionType {
  ...
  attributes: {
    magazine: Attribute.Media<'images' | 'files' | 'videos' | 'audios', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiMagzines3BuckectMagzines3Buckect
  extends Schema.CollectionType {
  collectionName: 'magzines3buckects';
  info: {
    singularName: 'magzines3buckect';
    pluralName: 'magzines3buckects';
    displayName: 'magzines3buckect';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::magzines3buckect.magzines3buckect',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
